...
screen_upload_too_big		=> "The screenshot file is too big! The maximum size allowed is {$ibforums->vars['d_screen_max_dwnld_size']}",
...
file_upload_big			=> "The file specified is too large to upload! The maximum size allowed is {$ibforums->vars['d_max_dwnld_size']}",
