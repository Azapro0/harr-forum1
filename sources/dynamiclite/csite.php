...
class click_site {
    ...
    function click_site()
    {
 	...
 	function _do_output()
 	{
        ...
        {
        	flush();
        	print "<html><head><title>Отладчик MYSQL</title><body bgcolor='white'><style type='text/css'> TABLE, TD, TR, BODY { font-family: verdana,arial, sans-serif;color:black;font-size:11px }</style>";
        	print $ibforums->debug_html;
        	echo "<br><div align='center' class='copyright'>Powered by <a href=\"http://www.invisionboard.com\" target='_blank'>Invision Power Board</a> {$ur} {$ibforums->version} &copy; <a href='http://www.invisionpower.com' target='_blank'>IPS, Inc.</a></div><br>
        ...
        $copyright = "<br><div align='center' class='copyright'>Powered by <a href=\"http://www.invisionboard.com\" target='_blank'>Invision Power Board</a> (U) v1.3 &copy; <a href='http://www.invisionpower.com' target='_blank'>IPS, Inc.</a></div><br>";
