...
class Moderate {
	...
	function split_complete() {
		...
		$this->moderate_log("Разделение темы '{$this->topic['title']}'");
	...
	function merge_complete() {
		...
		$this->moderate_log("Соединение темы '{$old_topic['title']}' с '{$this->topic['title']}'");
	...
	function poll_edit_do() {
		...
		$this->moderate_log("Редактирование опроса");
	...
	function do_move() {
		...
		$this->moderate_log("Перемещение темы из $source_name в $dest_name");
	...
	function delete_post() {
		...
		$this->moderate_log("Удаление сообщения");
	...
	function delete_topic()
	{
		...
		$this->moderate_log("Удаление темы");
	...
	function do_edit()
	{
		...
		$this->moderate_log("Редактирование заголовка темы: (ID: {$this->topic['tid']}) с '{$this->topic['title']}' на '$topic_title'");
	...
	function open_topic()
	{
		...
		$this->moderate_log("Открытие закрытой темы");
	...
	function close_topic()
	{
		...
		$this->moderate_log("Закрытие темы");
	...
	function pin_first_post() {
		...
		$this->moderate_log("Фиксирование первого сообщения темы");
		...
		@header("Местонахождение: ?act=ST&f=".$this->forum['id']."&t=".$this->topic['tid'] );
	...
	function unpin_first_post() {
		...
		$this->moderate_log("Опускание первого фиксированного сообщения темы");
	...
	function pin_topic()
	{
		...
		$this->moderate_log("Фиксирование темы");
	...
	function unpin_topic()
	{
		...
		$this->moderate_log("Опускание фиксированной темы");
