...
class ad_subscriptions {
	...
	function ad_subscriptions()
	{
		...
		$ADMIN->page_title = "Уравление подписками IPB";
		
		$ADMIN->page_detail = "В этой секции Вы можете устанавливать и управлять оплачиваемыми подписками пользователей.";
		
		$ADMIN->nav[] = array( 'act=msubs'              , 'Главная страница управления подписками' );
		$ADMIN->nav[] = array( 'act=msubs&code=dosearch', 'Показать всех подписанных пользователей' );
